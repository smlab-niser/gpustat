...
def main(*argv):
    ...
    parser.add_argument(
        '--show-ram', action='store_true', default=True,
        help='Display total system RAM usage in the header (default: enabled)'
    )
    parser.add_argument(
        '--no-ram', action='store_false', dest='show_ram',
        help='Do not display system RAM usage in the header'
    )
